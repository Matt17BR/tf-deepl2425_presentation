...
### Key Insights
- As polynomial degree increases, the model can tightly fit the training data (low training error).
- Beyond a certain complexity, test error rises, illustrating poor generalization.
