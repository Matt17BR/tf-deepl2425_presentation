...
\begin{frame}{Demonstrating Overfitting I}
\phantomsection\label{demonstrating-overfitting-i}
\begin{itemize}
\tightlist
\item
  \textbf{Objective}:
...
\begin{frame}{Demonstrating Overfitting II}
\phantomsection\label{demonstrating-overfitting-ii}
\begin{figure}[H]
...
\tightlist
\item
  \textbf{Vapnik-Chervonenkis Dimension (\(d_{\text{VC}}\))}: The size
  of the \emph{largest} dataset a model class can shatter.
\item
